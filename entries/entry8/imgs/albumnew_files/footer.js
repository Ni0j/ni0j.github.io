      ...
      '<footer class="m-footer-site jsc-footer">' +
        '<div class="mfs-content m-dn-sp">' +
          ...
          '<small>' +
            ...
            '<p class="mfs-copy">&copy; 1999-' + new Date().getFullYear() + ' JVCKENWOOD Victor Entertainment Corp. All rights reserved.</p>' +
          '</small>' +
        '</div>' +
        '<div class="m-menu-hamburger m-dn-pc">' +
          ...
          '<div class="mh-share-sns">' +
            ...
            '<ul>' +
              ...
              '<li><a href="https://vt.tiktok.com/ZSJhFCtW1/" target=_blank" class="cs-share-tiktok-sp m-link-img"></a></li>' +
              ...
              '<li><a href="http://live.line.me/channels/520" target=_blank" class="cs-share-linelive-sp m-link-img"></a></li>' +
